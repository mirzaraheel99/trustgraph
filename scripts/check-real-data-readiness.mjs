...
assertIncludes(evidenceMap, "Live Supabase migrations currently run through `052_billing_architecture_decision_receipts.sql`", "evidence map current migration boundary");
