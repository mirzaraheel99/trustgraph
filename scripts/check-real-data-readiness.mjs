...
assertIncludes(evidenceMap, "Live Supabase migrations currently run through `060_pilot_visibility_snapshot_seed.sql`", "evidence map current migration boundary");
