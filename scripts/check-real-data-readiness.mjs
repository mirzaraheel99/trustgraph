...
assertIncludes(evidenceMap, "Live Supabase migrations currently run through `047_v1_live_database_readiness_receipts.sql`", "evidence map current migration boundary");
