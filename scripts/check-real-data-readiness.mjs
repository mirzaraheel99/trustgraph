...
assertIncludes(evidenceMap, "Live Supabase migrations currently run through `048_corporate_database_access_receipts.sql`", "evidence map current migration boundary");
