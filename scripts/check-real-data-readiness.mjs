...
const appRequirements = [
  ...
  ["Hosted visual QA closeout", "hosted visual QA closeout label"],
  ["hosted_visual_qa_closeout", "hosted visual QA closeout packet mode"],
  [
    ...
    "hosted visual QA closeout acceptance rule"
  ],
