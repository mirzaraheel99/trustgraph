...
assert(css.includes("Daily SaaS route simplification") && css.includes(".portal-route-shell {\n  order: -30;") && css.includes(".portal-daily-command-center {\n  order: -20;"), "daily SaaS route simplification must put the tabbed portal route shell before dense proof panels.");
...
assert(css.includes("Public auth route simplification") && css.includes(".public-auth-card .public-account-access-path {\n  order: -50;") && css.includes(".public-auth-card .public-submit-readiness {\n  order: -30;"), "public auth route simplification must put account choice, route confirmation, corporate boundary, and submit readiness before credential fields.");
...
assert(css.includes("Corporate reviewer queue simplification") && css.includes(".verify-panel .corporate-directory-panel .corporate-reviewer-task-command {\n  order: -70;") && css.includes(".verify-panel .corporate-directory-panel .directory-controls {\n  order: -50;"), "Corporate reviewer queue simplification must put task, outcome, workbench, controls, and rows before proof-heavy panels.");
