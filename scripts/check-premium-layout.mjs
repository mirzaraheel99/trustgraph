...
assert(css.includes("Corporate setup simplification layer") && css.includes("#corporate-account-controls > .corporate-onboarding-pricing-cockpit") && css.includes("#corporate-account-controls > .setup-route-deck"), "corporate setup must keep one launch cockpit, command bar, and route deck while hiding duplicate helper panels.");
