...
const acceptanceChecks = [
  ...
  },
  {
    ...
    source: appSource,
    required: ["Corporate user database packet", "per-professional shared records", "Live corporate database", "live_database_evidence", "Export review queue", "Export user packet", "Corporate review attestations", "record_corporate_access_review", "Corporate visibility snapshot", "seedPilotVisibilitySnapshot"]
  },
  {
    id: "auth_recovery",
  ...
  },
  {
    ...
    source: appSource,
    required: ["Admin export readiness", "Audit filter receipt", "audit_filter_receipt", "Full audit and verification history packet", "Export releases", "Security review checklist", "Security RLS signoff packet", "security_rls_signoff_packet"]
  },
  {
    id: "pilot_readiness",
