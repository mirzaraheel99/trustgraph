...
if (!css.includes("grid-template-columns: minmax(224px, 252px) minmax(0, 1fr)") || !css.includes("contain: inline-size") || !css.includes("max-width: 252px")) {
...
if (!css.includes("width: min(100%, 1320px)") || !css.includes("grid-template-columns: repeat(3, minmax(0, 1fr))")) {
...
if (!css.includes(".workspace-command-strip") || !css.includes("grid-template-columns: minmax(180px, 0.62fr) minmax(0, 1.38fr) minmax(132px, auto)")) {
