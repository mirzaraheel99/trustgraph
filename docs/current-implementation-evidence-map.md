...
- VPS freshness checkpoint: top signed-in server proof surface for GitHub source, Pages smoke, VPS release stamp, manual save command, required deploy secrets, release-stamp URL, and VFIX route protection before accepting the server as current.
