...
| Account data rights | Signed-in Account panel for data export and closure requests, persisted metadata-only export package receipts, admin status controls, data-rights packets, audit and notification evidence | `supabase/migrations/038`, `supabase/migrations/039`, `supabase/migrations/050`, `src/dataRightsRepository.ts`, smoke account/admin checks |
